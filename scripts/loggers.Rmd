...
```{r}
temp_plot2<-tidbits%>%
  filter(group==c("ftr-tanks", "ftr-incubations"))%>%
...
Some of these are from incubations and others are from the tanks. I need to look back at my notes to determine which time slots we want to pull for loggers.  