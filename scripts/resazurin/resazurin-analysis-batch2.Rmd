...
full_data%>%
  ...
  geom_point()+
  geom_line()+
  scale_colour_manual(values=c("20C"="cyan4", "36C"="purple2", "40C"="orange", "42C"="darkred"))+
  theme_classic()
```
...
Treated and control rates are different at 36C and 40C, but not at 20C or 42C.  
...
plot1<-full_data%>%
  ...
  scale_colour_manual(values=c("20C"="cyan4", "36C"="purple2", "40C"="orange", "42C"="darkred"))+
  scale_fill_manual(values=c("20C"="cyan4", "36C"="purple2", "40C"="orange", "42C"="darkred"))+
  theme_classic()+
  xlab("Hour");plot1
...
plot2a<-ggplot(surv_model_data, aes(x = spat_treatment, y = predicted_mortality, color = temperature, fill = temperature, group=temperature)) +
  geom_point(aes(y = mortality), alpha = 0.6, position = position_jitter(height = 0.03)) +
  geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
  scale_colour_manual(values=c("20C"="cyan4", "36C"="orange", "40C"="darkred"))+
  scale_fill_manual(values=c("20C"="cyan4", "36C"="orange", "40C"="darkred"))+
  labs(
    title = "",
    y = "Probability of Mortality",
  ) +
