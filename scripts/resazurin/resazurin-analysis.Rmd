...
Residuals are violating normality. Attempt with square root transformation. 

```{r}
model<-lmer(sqrt(1+value) ~ timepoint * temperature * spat_treatment + (1|plate:well) + (1|holding_tank) + (1|spat_treatment:tank), data=full_data)
